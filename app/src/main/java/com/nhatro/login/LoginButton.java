...
//    }
    ...
    private void init() {
        ...
        signUpButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.mycolor));
...
//        }
        if (isLogin) {
            ...
            canvas.drawText(getString(R.string.sign_up), currentLoginX, currentLoginY, loginPaint);
        } else {
            ...
            canvas.drawText(getString(R.string.login), currentSignUpTextX, currentSignUpTextY, signUpPaint);
        }
    }
